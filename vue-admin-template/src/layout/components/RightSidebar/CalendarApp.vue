<template>
  <div class="calendar-container">
    <div class="flex">
      <calendar :range="calendar2.range" :lunar="calendar2.lunar" :value="calendar2.value" :begin="calendar2.begin" :end="calendar2.end" @select="calendar2.select" />
    </div>

    <transition name="fade">
      <div v-if="calendar3.show" class="calendar-dropdown" :style="{'left':calendar3.left+'px','top':calendar3.top+'px'}">
        <calendar :zero="calendar3.zero" :lunar="calendar3.lunar" :value="calendar3.value" :begin="calendar3.begin" :end="calendar3.end" @select="calendar3.select" />
      </div>
    </transition>

    <transition name="fade">
      <div v-if="calendar4.show" class="calendar-dialog">
        <div class="calendar-dialog-mask" @click="closeByDialog" />

        <div class="calendar-dialog-body">
          <calendar :range="calendar4.range" :zero="calendar4.zero" :lunar="calendar4.lunar" :value="calendar4.value" @select="calendar4.select" />
        </div>
